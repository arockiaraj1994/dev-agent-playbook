...
see_also: [tool:playbook_start_requirement, tool:playbook_list_requirements, core:guardrails]
---

# Workflow: write-prd

1. Call `playbook_start_requirement(project="nexre", intent="…", type="prd")`.
